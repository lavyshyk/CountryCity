...
class SaveLanguagesToDataBaseUseCase(private val mDataBaseRepository: DataBaseRepository) :
    ...
    override fun buildFlowable(params: Pair<String, MutableList<LanguageDto>>?): Flowable<Unit> =
        mDataBaseRepository.saveLanguages(params?.first ?: "", params?.second ?: mutableListOf())
